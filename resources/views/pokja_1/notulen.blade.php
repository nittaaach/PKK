...
@section('content_admin')
    ...
    @include('admin-temp.partials.import_modal', [
        'importRoute' => 'notulen.import_pokja1',
        'title'       => 'Import Data Notulen Pokja I',
    ...
    <div id="AddModal" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('notulen.store_pokja1') }}" method="POST">@csrf
        ...
        <div id="UpdateModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('notulen.update_pokja1', $item->id) }}" method="POST">@csrf @method('PUT')
                        <div class="modal-body">
                            <div class="row">
        ...
        <div id="DeleteModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('notulen.destroy_pokja1', $item->id) }}" method="POST">@csrf @method('DELETE')
    ...
    <script>
        ...
        function printSelected() {
            ...
            window.open("{{ route('notulen.print_report') }}?ids=" + selected.join(',') + "&role=pokja1", '_blank');
        }
    </script>
@endsection
