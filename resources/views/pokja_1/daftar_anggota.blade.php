...
@section('content_admin')
                    ...
                    <div class="card-body">
                        ...
                        <tfoot>
                            <tr class="fw-bold bg-light">
                                ...
                                <th class="text-center"></th>
                                <th class="text-center"></th>
                                <th class="text-center">{{ $anggota_pokja1->sum('umur') ?: '-' }}</th>
                                <th class="text-center"></th>
                                <th class="text-center"></th>
                                <th class="text-center"></th>
                                <th class="text-center"></th>
    ...
    @include('admin-temp.partials.import_modal', [
        'importRoute' => 'daftar_anggota.import_pokja1',
        'title'       => 'Import Daftar Anggota Pokja 1',
    ...
    <div id="AddAnggotaModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="AddAnggotaModalTitle"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document"> <!-- Tambah modal-lg biar agak lebar -->
            <div class="modal-content">
                ...
                <form action="{{ route('daftar_anggota.store_anggota_pokja1') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="role_pkk">
                                    ...
                                    <option value="pokja_1">pokja_1</option>
        ...
        <div id="UpdateAnggotaModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('daftar_anggota.update_anggota_pokja1', $item->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <!-- Kedudukan / Jabatan -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Jabatan di PKK</label>
                                    <select class="form-select" name="role_pkk">
                                        <oppokja_1tion value="Anggota"
                                            {{ $item->role_pkk == 'Anggota' ? 'selected' : '' }}>
                                            Anggota</option>
                                            <option value="pokja_1" {{ $item->role_pkk == '' ? 'selected' : '' }}>
                                                pokja_1</option>
        ...
        <div id="DeleteAnggotaModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('daftar_anggota.destroy_anggota_pokja1', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
