    ...
    <div id="AddSuratMasukModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('agenda_surat.store_masuk_pokja2') }}" method="POST">
                    @csrf
        ...
        <div id="UpdateSuratMasukModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('agenda_surat.update_masuk_pokja2', $item->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row">
        ...
        <div id="DeleteSuratMasukModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('agenda_surat.destroy_masuk_pokja2', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <div id="AddSuratKeluarModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('agenda_surat.store_keluar_pokja2') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
        ...
        <div id="UpdateSuratKeluarModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('agenda_surat.update_keluar_pokja2', $item->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row">
        ...
        <div id="DeleteSuratKeluarModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('agenda_surat.destroy_keluar_pokja2', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <div class="p-3 text-center">
