            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Laporan Kegiatan @if($is_read_only ?? false) <span class="badge bg-info">Lihat Saja</span> @endif</h2>
        ...
        <div class="card">
            <div class="card-body">
                <div class="dt-responsive table-responsive">
                    ...
                    <div class="py-3">
                        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#AddModal"><i class="ti ti-plus me-1"></i> Tambah Laporan</button>
                        ...
                        <tbody>
                            @foreach ($data ?? [] as $item)
                                <tr>
                                    ...
                                    <td style="min-width:300px; white-space:normal">{!! nl2br(e(\Illuminate\Support\Str::limit($item->isi_laporan, 300) ?? '-')) !!}</td>
                                    @if(!($is_read_only ?? false))
                                    <td>
    ...
    <div id="AddModal" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('lap_kegiatan.store_pokja3') }}" method="POST">@csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3"><label class="form-label">Dasar (No. Surat)</label><input type="text" class="form-control" name="dasar" placeholder="cth: 001/Skr/PKK.Kec/I/2025"></div>
                            ...
                            <div class="col-md-12 mb-3"><label class="form-label">Isi Laporan</label><textarea class="form-control" name="isi_laporan" rows="8"></textarea></div>
                        </div>
                    </div>
        ...
        <div id="UpdateModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('lap_kegiatan.update_pokja3', $item->id) }}" method="POST">@csrf @method('PUT')
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3"><label class="form-label">Isi Laporan</label><textarea class="form-control" name="isi_laporan" rows="8">{{ $item->isi_laporan }}</textarea></div>
                            </div>
                        </div>
        ...
        <div id="DeleteModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('lap_kegiatan.destroy_pokja3', $item->id) }}" method="POST">@csrf @method('DELETE')
                            <div class="text-center p-3"><h5>Hapus laporan <strong class="text-danger">{{ $item->acara }}</strong>?</h5></div>
    ...
    <div id="ImportModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('Pokja_3.import_lap_kegiatan') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
