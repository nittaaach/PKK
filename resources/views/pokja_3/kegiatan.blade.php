...
@section('content_admin')
    ...
    @include('admin-temp.partials.import_modal', [
        'importRoute' => 'kegiatan.import_pokja3',
        'title'       => 'Import Data Kegiatan Pokja 3',
    ...
    <div id="AddKegiatanModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('kegiatan.store_pokja3') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div id="UpdateKegiatanModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('kegiatan.update_pokja3', $item->id) }}" method="POST"
        ...
        <div id="DeleteKegiatanModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('kegiatan.destroy_pokja3', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
