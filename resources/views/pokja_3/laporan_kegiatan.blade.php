...
@section('content_admin')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Laporan Kegiatan / Rapat @if($is_read_only ?? false) <span class="badge bg-info">Lihat Saja</span> @endif</h2>
            ...
            <div class="card-body">
                <div class="dt-responsive table-responsive">
                    <div class="py-3">
                        ...
                        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#AddModal"><i class="ti ti-plus me-1"></i> Tambah Laporan Kegiatan</button>
    ...
    <div id="AddModal" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('laporan_kegiatan.store_pokja3') }}" method="POST">@csrf
        ...
        <div id="UpdateModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('laporan_kegiatan.update_pokja3', $item->id) }}" method="POST">@csrf @method('PUT')
                        <div class="modal-body">
                            <div class="row">
        ...
        <div id="DeleteModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('laporan_kegiatan.destroy_pokja3', $item->id) }}" method="POST">@csrf @method('DELETE')
    ...
    @include('admin-temp.partials.import_modal', [
        'importRoute' => 'laporan_kegiatan.import_pokja3',
        'title'       => 'Import Data Laporan Kegiatan / Rapat Pokja III',
    ...
    <script>
        ...
        function printSelected() {
            ...
            window.open("{{ route('laporan_kegiatan.print_report') }}?ids=" + selected.join(',') + "&role=pokja3", '_blank');
        }
    </script>
@endsection
