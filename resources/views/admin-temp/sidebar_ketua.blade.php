<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
    ...
    <!-- [ Sidebar Menu ] start -->
    @php
        $role = Auth::guard('ketua')->user()->role;
        $routePrefix = "{$role}.";
                    ...
                    <li class="dropdown pc-h-item header-user-profile">
                        <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown"
                            ...
                            <img src="{{ asset('assets_admin/images/user/avatar-2.jpg') }}" alt="user-image"
                                class="user-avtar">
                            <span>{{ Auth::guard('ketua')->user()->name ?? 'Guest' }}</span>
                        </a>
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            <div class="dropdown-header d-flex align-items-center justify-content-between">
                                <div class="d-flex mb-1 align-items-center">
                                    <div class="grow ms-3">
                                        <h6 class="mb-1">{{ Auth::guard('ketua')->user()->name ?? 'Guest' }}</h6>
                                        <span>{{ Auth::guard('ketua')->user()->role ?? 'Tidak Ada Role' }}</span>
                                    </div>
                                </div>
                            </div>
