...
<head>
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="{{ asset('assets_admin/images/logo_pkk.png') }}" type="image/x-icon"> <!-- [Google Font] Family -->
    <link rel="stylesheet"="https://fonts.googleapis.com/css2?family=Public+Sans:wght@300;400;500;600;700&display=swap"
        id="main-font-link">
    <!-- data tables css -->
    <link rel="stylesheet" href="{{ asset('assets_admin/css/plugins/dataTables.bootstrap5.min.css') }}">
    <!-- [Google Font] Family -->
    <link rel="stylesheet"
    ...
    <link rel="stylesheet" href="{{ asset('assets_admin/css/plugins/datepicker-bs5.min.css') }}">
    <!-- Choices.js CSS -->
