...
<head>
    ...
    <title>Laporan Kegiatan / Rapat - {{ $role_label }}</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .item + .item { border-top: 2px dashed #ccc; padding-top: 40px; }
        ...
        @media print {
            ...
            .item + .item { page-break-before: always; border-top: none; padding-top: 0; }
        }
    </style>
</head>
<body>
<div class="print-wrapper">
    ...
    <div class="no-print">
        ...
        <p style="margin-top:8px; font-size:13px; color:#555;">Mencetak <strong>{{ $items->count() }}</strong> laporan kegiatan — {{ $role_label }}</p>
    </div>

    @foreach($items as $item)
        <div class="item">
            <div class="doc-title">LAPORAN KEGIATAN / RAPAT</div>
            ...
            <p class="hasil-rapat-label">Hasil Kegiatan / Rapat &nbsp;&nbsp;:</p>
