<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
    ...
    <!-- [ Sidebar Menu ] start -->
    @php
        $role = Auth::guard('pokja_2')->user()->role;
        $routePrefix = "{$role}.";
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            ...
                            <span class="pc-mtext">Database BKB Paud</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-users"></i></span>
                            <span class="pc-mtext">Pojok Baca</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                    ...
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            ...
                            <span class="pc-mtext">Kalender Kegiatan Tahunan</span>
                        </a>
                    </li> --}}
                    ...
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            ...
                            <span class="pc-mtext">Data Koperasi</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-building-community"></i></span>
                            <span class="pc-mtext">Dana Bergulir</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-building-community"></i></span>
                            <span class="pc-mtext">Klasifikasi Klmpk UP2K</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                    ...
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-building-community"></i></span>
                            <span class="pc-mtext">Matrik</span>
                        </a>
                    </li> --}}
                </ul>
            </div>
                    ...
                    <li class="dropdown pc-h-item header-user-profile">
                        <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                            ...
                            <img src="{{ asset('assets_admin/images/user/avatar-2.jpg') }}" alt="user-image"
                                class="user-avtar">
                            <span>{{ Auth::guard('pokja_2')->user()->name ?? 'Guest' }}</span>
                        </a>
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            <div class="dropdown-header d-flex align-items-center justify-content-between">
                                <div class="d-flex mb-1 align-items-center">
                                    <div class="grow ms-3">
                                        <h6 class="mb-1">{{ Auth::guard('pokja_2')->user()->name ?? 'Guest' }}</h6>
                                        <span>{{ Auth::guard('pokja_2')->user()->role ?? 'Tidak Ada Role' }}</span>
                                    </div>
                                </div>
                            </div>
