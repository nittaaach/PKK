<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
    ...
    @php
        ...
        $role = Auth::guard('sekretaris')->user()->role;
        $routePrefix = "{$role}.";
        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li
                        class="pc-item {{ request()->routeIs($routePrefix . 'data_potensi_wilayah') ? 'pc-active' : '' }}">
                        <a href="{{ route($routePrefix . 'data_potensi_wilayah') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-location"></i></span>
                            <span class="pc-mtext">Data Potensi Wilayah</span>
                        </a>
                    </li>
                    <li class="pc-item {{ request()->routeIs($routePrefix . 'data_umum') ? 'pc-active' : '' }}">
                        <a href="{{ route($routePrefix . 'data_umum') }}" class="pc-link">
                    ...
                    <li class="pc-item {{ request()->routeIs($routePrefix . 'buku_notulen_rapat') ? 'pc-active' : '' }}">
                        <a href="{{ route($routePrefix . 'buku_notulen_rapat') }}" class="pc-link">
                    ...
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            ...
                            <span class="pc-mtext">Piagam</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                    ...
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            ...
                            <span class="pc-mtext">SK & Payung Hukum</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-receipt"></i></span>
                            <span class="pc-mtext">Pengantar Tanda Terima</span>
                        </a>
                    </li> --}}
                    ...
                    <li class="pc-item">
                        <a href="#" class="pc-link">
                            ...
                            <span class="pc-mtext">Data Kegiatan Warga</span>
                        </a>
                    </li>
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            ...
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                                    <span class="pc-mtext">Buku Jadwal Piket</span>
                                </a>
                            </li>
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                                    <span class="pc-mtext">Buku Kliping</span>
                                </a>
                            </li>
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                                    <span class="pc-mtext">Buku Notulensi Rapat</span>
                                </a>
                            </li>
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                                    <span class="pc-mtext">Buku Prestasi</span>
                                </a>
                            </li>
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                                    <span class="pc-mtext">Buku Program Kerja & Evaluasi</span>
                                </a>
                            </li>
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                    ...
                    {{-- <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                                    <span class="pc-mtext">Data Ibu Hamil & Balita</span>
                                </a>
                            </li>
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                            ...
                            <li class="pc-item">
                                <a href="#" class="pc-link">
                                    <span class="pc-mtext">Kegiatan Posyandu</span>
                                </a>
                            </li>
                        </ul>
                    </li> --}}
                    ...
                    <li class="dropdown pc-h-item header-user-profile">
                        <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown"
                            ...
                            <img src="{{ asset('assets_admin/images/user/avatar-2.jpg') }}" alt="user-image"
                                class="user-avtar">
                            <span>{{ Auth::guard('sekretaris')->user()->name ?? 'Guest' }}</span>
                        </a>
