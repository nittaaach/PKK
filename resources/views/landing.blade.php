            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        ...
                        <p data-aos="fade-up" data-aos-delay="100">Situs Resmi PKK Kelurahan Cipinang Melayu, Kecamatan
                            Makasar,
                            Jakarta Timur
                        </p>
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                        ...
                        @else
                            ...
                            <img src="{{ asset('assets-user/img/rw12_1.jpg') }}" class="img-fluid animated"
                                onerror="this.onerror=null; this.src='{{ asset('assets-user/img/home.jpeg') }}';"
                    ...
                    <div class="col-lg-12 d-flex flex-column justify-content-center" data-aos="fade-up"
                        ...
                        <div class="content text-center">
                            ...
                            <p>
                                ...
                                Melalui platform ini, warga dapat memperoleh informasi mengenai program pola asuh anak
                                berbasis
                                nilai Pancasila, pemantauan kesehatan keluarga, pelatihan keterampilan, hingga promosi
                                produk
                                UMKM binaan PKK demi meningkatkan kemandirian ekonomi warga Cipinang Melayu.

                                Kami percaya bahwa kemudahan akses informasi dan pemanfaatan teknologi adalah langkah
                                penting
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="card">
                            ...
                            <p>Temukan berbagai agenda, program pemberdayaan, dan aktivitas sosial mendatang. Mari bergabung
                                dan
                                berpartisipasi!</p>
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="card">
                            ...
                            <p>Lihat kembali dokumentasi dan kilas balik program kerja yang telah sukses diselenggarakan
                                bersama
                                masyarakat.</p>
                ...
                "breakpoints": {
                    ...
                    <div class="swiper-wrapper align-items-center">
                        ...
                        <div class="swiper-slide"><img src="assets-user/img/clients/dikti.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img src="assets-user/img/logo_pkk.png" class="img-fluid"
                                alt="">
                        </div>
                        <div class="swiper-slide"><img src="assets-user/img/clients/UNM.png" class="img-fluid"
                                alt=""></div>
