...
@section('content_admin')
    ...
    @include('admin-temp.partials.import_modal', [
        'importRoute' => 'laporan_kegiatan.import_pokja4',
        'title'       => 'Import Data Laporan Kegiatan / Rapat Pokja IV',
    ...
    <div id="AddModal" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('laporan_kegiatan.store_pokja4') }}" method="POST">@csrf
        ...
        <div id="UpdateModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('laporan_kegiatan.update_pokja4', $item->id) }}" method="POST">@csrf @method('PUT')
                        <div class="modal-body">
                            <div class="row">
        ...
        <div id="DeleteModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('laporan_kegiatan.destroy_pokja4', $item->id) }}" method="POST">@csrf @method('DELETE')
    ...
    <script>
        ...
        function printSelected() {
            ...
            window.open("{{ route('laporan_kegiatan.print_report') }}?ids=" + selected.join(',') + "&role=pokja4", '_blank');
        }
    </script>
@endsection
