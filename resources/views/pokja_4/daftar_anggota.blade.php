            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Data Anggota Pokja 4</li>
                    </ul>
                </div>
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Data Anggota Pokja 4</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            ...
                            <table id="basic-btn-da" class="table table-striped table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    @foreach ($anggota_pokja4 as $item)
                                        <tr>
                        ...
                        <tfoot>
                            <tr class="fw-bold bg-light">
                                ...
                                <th class="text-center"></th>
                                <th class="text-center"></th>
                                <th class="text-center">{{ $anggota_pokja4->sum('umur') ?: '-' }}</th>
                                <th class="text-center"></th>
                                <th class="text-center"></th>
                                <th class="text-center"></th>
                                <th class="text-center"></th>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">Form Tambah Anggota Pokja 4</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>

                <form action="{{ route('daftar_anggota.store_anggota_pokja4') }}" method="POST"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title">Form Update Anggota Pokja 4</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>

                    <form action="{{ route('daftar_anggota.update_anggota_pokja4', $item->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
        ...
        <div id="DeleteAnggotaModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('daftar_anggota.destroy_anggota_pokja4', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
