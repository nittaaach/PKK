...
@section('content_admin')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dt-responsive table-responsive">
                                ...
                                <table id="basic-btn-kegiatan" class="table table-striped table-bordered"
                                    style="width: 100%;">
                                    <thead>
                                        <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($item->tanda_tangan)
                                                        <img src="{{ asset('storage/' . $item->tanda_tangan) }}"
                                                            alt="TTD" style="height: 50px; cursor: pointer;"
    ...
    @include('admin-temp.partials.import_modal', [
        'importRoute' => 'kegiatan.import_sekretaris',
    ...
    <div id="AddKegiatanModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('kegiatan.store_sekretaris') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div id="UpdateKegiatanModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('kegiatan.update_sekretaris', $item->id) }}" method="POST"
        ...
        <div id="DeleteKegiatanModal-{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('kegiatan.destroy_sekretaris', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
