...
@section('content_admin')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        ...
                        <p class="text-muted mt-1">TP PKK Kelurahan Cipinang Melayu - Sekretaris</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="dt-responsive table-responsive">
                    <div class="py-3">
                        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#AddModal">
                            <i class="ti ti-plus me-1"></i> Tambah Laporan Kegiatan
                        </button>
                        ...
                        <button type="button" class="btn btn-info" onclick="printSelected()">
                            <i class="ti ti-printer me-1"></i> Print Laporan Kegiatan
                        </button>
                    </div>
    ...
    @include('admin-temp.partials.import_modal', [
        'importRoute' => 'laporan_kegiatan.import_sekretaris',
        'title'       => 'Import Data Laporan Kegiatan / Rapat Sekretaris',
    ...
    <div id="AddModal" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('laporan_kegiatan.store_sekretaris') }}" method="POST">@csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3"><label class="form-label">Dasar (No. Surat)</label><input type="text" class="form-control" name="dasar" placeholder="cth: 001/Sekretaris/PKK.Kel/I/2025"></div>
        ...
        <div id="UpdateModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('laporan_kegiatan.update_sekretaris', $item->id) }}" method="POST">@csrf @method('PUT')
                        <div class="modal-body">
                            <div class="row">
        ...
        <div id="DeleteModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('laporan_kegiatan.destroy_sekretaris', $item->id) }}" method="POST">@csrf @method('DELETE')
    ...
    <script>
        ...
        function printSelected() {
            ...
            window.open("{{ route('laporan_kegiatan.print_report') }}?ids=" + selected.join(',') + "&role=sekretaris", '_blank');
        }
    </script>
@endsection
