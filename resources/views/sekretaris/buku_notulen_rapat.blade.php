...
@section('content_admin')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Buku Notulen Rapat</li>
                    </ul>
                </div>
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Buku Notulen Rapat</h2>
    ...
    @include('admin-temp.partials.import_modal', [
        'importRoute' => 'notulen.import_sekretaris',
        'title'       => 'Import Data Notulen Sekretaris',
    ...
    <div id="AddModal" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('notulen.store_sekretaris') }}" method="POST">@csrf
        ...
        <div id="UpdateModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('notulen.update_sekretaris', $item->id) }}" method="POST">@csrf @method('PUT')
                        <div class="modal-body">
                            <div class="row">
        ...
        <div id="DeleteModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('notulen.destroy_sekretaris', $item->id) }}" method="POST">@csrf @method('DELETE')
    ...
    <script>
        ...
        function printSelected() {
            ...
            window.open("{{ route('notulen.print_report') }}?ids=" + selected.join(',') + "&role=sekretaris", '_blank');
        }
    </script>
@endsection
