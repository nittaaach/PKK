...
@section('content_admin')
                        ...
                        <div class="dt-responsive table-responsive">
                            <div class="py-3">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#ImportSuratKeluarModal">
                                    <i class="ti ti-file-import me-1"></i> Import File
                                </button>
                            </div>
    ...
    @include('admin-temp.partials.import_modal', [
        'modalId'     => 'ImportSuratMasukModal',
        'importRoute' => 'agenda_surat.import_masuk_sekretaris',
        'title'       => 'Import Data Surat Masuk',
        'columns'     => 'tanggal_terima, tanggal_surat, no_surat, asal_surat, perihal, lampiran, diteruskan_kepada',
    ])

    @include('admin-temp.partials.import_modal', [
        'modalId'     => 'ImportSuratKeluarModal',
        'importRoute' => 'agenda_surat.import_keluar_sekretaris',
